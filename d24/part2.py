...
def solve(map, backtrack, delay):
    print('solve', backtrack, delay)
    ...
    if costs[end] == 0:
        return solve(map, backtrack, delay+1)
...
trip1 = solve(map, False, 0)
print('steps =', trip1)

trip2 = solve(map, True, trip1)
print('steps =', trip2)

trip3 = solve(map, False, trip2)
print('steps =', trip3)
